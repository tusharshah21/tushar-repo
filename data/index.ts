...
export const testimonials = [
  ...
  {
    quote:
      "Tushar shows strong potential and a willingness to grow. With more proactiveness and timely communication, he can become a truly valuable asset. He's learning to take initiative, think beyond his role, and approach tasks with clarity and ownership.",
    name: "Maximilien S.",
    title: "Co-founder (Innovmeta)",
    img: "/linkedin/max.jpg",
  },
];
